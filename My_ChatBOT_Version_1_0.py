...
#for getting the reply from end-user
	...
	if (("Taskmanager" in p) or ("taskmanager" in p) or ("TASKMANAGER" in p) or ("TaskManager" in p))  and (("open" in p) or ("show"in p) or ("start" in p) or ("launch" in p) or ("begin" in p)):
		...
		print(">>",cb_name,"    : Gonna change sytem startup configurations.. Go Ahead sir!! ")
		pyttsx3.speak("	Gonna change sytem startup configurations.. Go Ahead sir!! ")
		os.system("msconfig")
		...
		print(">>",cb_name,"    : Oh no!! Lagging in performance I will open it for you sir")
		...
		print(">>",cb_name,"    : Amazing!!! Your system is having powerful specifications.. If you don't believe i will show you sir")
		pyttsx3.speak("	Amazing!!! Your system is having powerful specifications.. If you don't believe me see it sir")
		os.system("msinfo32")
		...
		print(">>",cb_name,"    : Fine Sir!! Browse whatever you want but just clear the history sir.. :D")
		pyttsx3.speak("	Fine Sir!! Browse whatever you want but just clear the history sir..")
		...
		pyttsx3.speak("OOPS!!! Please provide me a valid search query to proceed")
print("-----------------------------------------------------[ VIMAL DAGA ]----------------------------------------------------")
